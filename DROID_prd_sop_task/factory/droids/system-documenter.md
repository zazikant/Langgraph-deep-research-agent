...
description: >-
  System Documentation sub-agent for the System folder. Analyzes codebase architecture,
  schemas, and API specifications. Updates System folder with structural information.
