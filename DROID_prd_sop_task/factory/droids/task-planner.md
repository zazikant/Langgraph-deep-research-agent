...
name: task-planner
description: >-
  Task Planning sub-agent for the Task folder. Reads requirements, analyzes codebase, 
  and creates Product Requirement Documents (PRDs) with implementation plans. Returns 
  compact, actionable plans to the main agent.
model: inherit
---
